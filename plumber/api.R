  ...
  subsidy_r = 0) 
{
  ...
  strawberry_pr<-as.numeric(strawberry_pr)
  pumpkin_pr<-as.numeric(pumpkin_pr)
  tomato_pr<-as.numeric(tomato_pr)
  pepper_pr<-as.numeric(pepper_pr)
  strawberry_s_pr<-as.numeric(strawberry_s_pr)
  pumpkin_s_pr<-as.numeric(pumpkin_s_pr)
  tomato_s_pr<-as.numeric(tomato_s_pr)
  pepper_s_pr<-as.numeric(pepper_s_pr)
  strawberry_yr<-as.numeric(strawberry_yr)
  pumpkin_yr<-as.numeric(pumpkin_yr)
  tomato_yr<-as.numeric(tomato_yr)
  pepper_yr<-as.numeric(pepper_yr)
  strawberry_s_yr<-as.numeric(strawberry_s_yr)
  pumpkin_s_yr<-as.numeric(pumpkin_s_yr)
  tomato_s_yr<-as.numeric(tomato_s_yr)
  pepper_s_yr<-as.numeric(pepper_s_yr)
  strawberry_cr<-as.numeric(strawberry_cr)
  pumpkin_cr<-as.numeric(pumpkin_cr)
  tomato_cr<-as.numeric(tomato_cr)
  pepper_cr<-as.numeric(pepper_cr)
  strawberry_s_cr<-as.numeric(strawberry_s_cr)
  pumpkin_s_cr<-as.numeric(pumpkin_s_cr)
  tomato_s_cr<-as.numeric(tomato_s_cr)
  pepper_s_cr<-as.numeric(pepper_s_cr)
  energy_cost_r<-as.numeric(energy_cost_r)
  water_constraint_r<-as.numeric(water_constraint_r)
  land_constraint_r<-as.numeric(land_constraint_r)
  rice_ratio<-as.numeric(rice_ratio)
  rice_o_ratio<-as.numeric(rice_o_ratio)
  tomato_ratio<-as.numeric(tomato_ratio)
  tomato_s_ratio<-as.numeric(tomato_s_ratio)
  strawberry_ratio<-as.numeric(strawberry_ratio)
  strawberry_s_ratio<-as.numeric(strawberry_s_ratio)
  pumpkin_ratio<-as.numeric(pumpkin_ratio)
  pumpkin_s_ratio<-as.numeric(pumpkin_s_ratio)
  pepper_ratio<-as.numeric(pepper_ratio)
  pepper_s_ratio<-as.numeric(pepper_s_ratio)
  subsidy_r<-as.numeric(subsidy_r)
